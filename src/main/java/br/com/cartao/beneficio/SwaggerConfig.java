package br.com.cartao.beneficio;
...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("br.com.cartao.beneficio.controller"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("cartao-beneficio-api");
		apiInfoBuilder.description("Project backend Cartão Benefício");
